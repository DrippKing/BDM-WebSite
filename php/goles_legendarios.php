...
// El título de la página es fijo para esta sección.
$titulo_formateado = 'Goles Legendarios';

// Consultamos la tabla `legendary_goals` en lugar de `posts`.
$momentos_a_mostrar = [];
$sql = "SELECT 
            `title` AS titulo,
        ...
        FROM `legendary_goals` ORDER BY `id` ASC";
